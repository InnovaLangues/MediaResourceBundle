...
class Version20150312093907 extends AbstractMigration
{
    ...
    {
        $this->addSql("
            ALTER TABLE innova_media_resource_region ALTER media_resource_id TYPE INT
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_region ALTER media_resource_id 
            DROP DEFAULT
        ");
        $this->addSql("
        ...
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_media ALTER media_resource_id TYPE INT
        ");
        $this->addSql("
    ...
    public function down(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_media ALTER media_resource_id TYPE VARCHAR(255)
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_media ALTER media_resource_id 
            DROP DEFAULT
        ...
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_region ALTER media_resource_id TYPE VARCHAR(255)
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_region ALTER media_resource_id 
            DROP DEFAULT
