...
class Version20150312093907 extends AbstractMigration
{
    ...
    {
        $this->addSql("
            ALTER TABLE innova_media_resource_region ALTER media_resource_id INT NOT NULL
        ");
        $this->addSql("
        ...
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_media ALTER media_resource_id INT NOT NULL
        ");
        $this->addSql("
    ...
    public function down(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            DROP INDEX innova_media_resource_media.IDX_5C0330F07E5AEFB6
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_media ALTER media_resource_id VARCHAR(255) NOT NULL
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_region 
        ...
        ");
        $this->addSql("
            DROP INDEX innova_media_resource_region.IDX_BB5F60D07E5AEFB6
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_region ALTER media_resource_id VARCHAR(255) NOT NULL
        ");
    }
}