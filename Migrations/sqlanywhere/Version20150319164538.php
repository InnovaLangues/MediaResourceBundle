 ...
 *
 * Generation date: 2015/03/19 04:45:40
 */
class Version20150319164538 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        ");
        $this->addSql("
            DROP INDEX innova_media_resource_region_config.UNIQ_FEBE556198A93AD1
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_region_config 
    ...
    {
        $this->addSql("
            ALTER TABLE innova_media_resource_media ALTER media_resource_id INT DEFAULT NULL
        ");
        $this->addSql("
            ALTER TABLE innova_media_resource_region_config 
